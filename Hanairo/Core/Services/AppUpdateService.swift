...
enum AppUpdateService {
    nonisolated static let repositoryURL = URL(string: "https://github.com/youshen2/Hanairo")!
    private nonisolated static let latestReleaseURL = URL(
        string: "https://api.github.com/repos/youshen2/Hanairo/releases/latest"
    )!
    ...
    nonisolated static func checkLatestRelease(currentVersion: String) async throws -> AppUpdateResult {
        ...
        request.setValue("Hanairo", forHTTPHeaderField: "User-Agent")
